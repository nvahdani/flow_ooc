...
hisat2_extract_splice_sites.py /reference110/genome.gtf > /data/users/nvahdani/flow_project/reference110/genome.ss
hisat2_extract_exons.py /reference110/genome.gtf > /data/users/nvahdani/flow_project/reference110/genome.exon
